...
const Edit = ({ isOpen, onClose, branch }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
      <div className="bg-gray-800 rounded-xl border border-gray-700 shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200 text-gray-100">
        <div className="px-6 py-4 border-b border-gray-700 flex items-center justify-between bg-gray-800">
          <h2 className="text-lg font-bold text-white">Edit Data Cabang</h2>
          <button
            onClick={closeModal}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                value={data.code}
                readOnly
                placeholder="Klik tombol untuk regenerasi kode"
          ...
          <div className="flex items-center gap-2 pt-2">
            ...
            />
            <label htmlFor="is_active_edit" className="text-sm font-medium text-gray-300 select-none">
              Status Cabang Aktif
            </label>
          </div>
          ...
          <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-700">
            ...
            >
              {processing ? 'Menyimpan...' : 'Perbarui Cabang'}
            </button>
          </div>
        </form>
      </div>
